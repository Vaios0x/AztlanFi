...
export default function AboutPage() {
  const values = [
    ...
    },
    {
      ...
      description: "Protect every transaction with next-generation blockchain technology",
    ...
    },
    {
      ...
      description: "Bring financial services to underserved communities worldwide",
  ...
  const team = [
    ...
    },
    {
      ...
      bio: "Product manager with UX focus. Experience in mobile apps and financial services.",
  ...
  const milestones = [
    ...
    },
    {
      year: "2024",
      title: "10,000 Users",
      description: "We reached our first milestone of active users"
    },
    {
      year: "2025",
      title: "Regional Expansion",
      description: "We reached 5 countries in Latin America"
    },
    {
      year: "2025",
      title: "Series A",
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div>
                ...
                <div className="space-y-6 text-gray-600 leading-relaxed">
                  <p>
                    ...
                    too much to send money home. In 2024, our team of engineers and entrepreneurs 
                  ...
                  <p>
                    Today, we are proud to serve thousands of families, reducing their remittance 
                    costs by 95% and connecting them instantly with their loved ones.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                <div className="bg-gradient-to-br from-monad-600 to-purple-700 rounded-3xl p-8 text-white">
                  ...
                  <blockquote className="text-xl font-medium mb-6">
                    "Our mission is simple: democratize remittances. Every dollar we save 
                ...
                {team.map((member, index) => (
                  ...
                  >
                    ...
                    <div className="flex justify-center space-x-3">
                      <a href={member.social.linkedin} className="text-gray-400 hover:text-blue-600 transition-colors" aria-label={`${member.name}'s LinkedIn`}>
                        <Linkedin size={20} />
                      </a>
                      <a href={member.social.twitter} className="text-gray-400 hover:text-blue-400 transition-colors" aria-label={`${member.name}'s Twitter`}>
                        <Twitter size={20} />
                      </a>
                      <a href={member.social.github} className="text-gray-400 hover:text-gray-800 transition-colors" aria-label={`${member.name}'s GitHub`}>
                        <Github size={20} />
                      </a>
                    </div>
                  </motion.div>
            ...
            >
              <div className="text-center">
                ...
                <p className="text-gray-600">San Francisco, CA<br />Mexico City, MX</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">hello@aztlanfi.com<br />support@aztlanfi.com</p>
              </div>
            </motion.div>
          </div>
        </section>
